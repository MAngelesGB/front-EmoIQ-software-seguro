    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route
            path="personnel"
            element={<AdminPanel openModal={openModal} />}
          />
          <Route
            path="statistics"
            element={
          ...
          <Route
            ...
            element={
              ...
              >
                <h1>Sugerencias de contenido</h1>
              </div>
            }
          />
          <Route
        ...
        <Route
          path="/manager"
          element={
            <ProtectedRoute isAllowed={role === 'manager'}>
              <Layout />
            </ProtectedRoute>
          }
        >
          ...
          <Route
            path="content/:categoryId/suggestion"
            element={<ContentManagementSuggest openModal={openModal} />}
          />
          <Route
            path="content/:categoryId/:lectureId"
            element={<ContentManagementPreview />}
          />
          <Route
            path="content/:categoryId/:lectureId/edit"
            element={<ContentManagementEdit openModal={openModal} />}
          />
        </Route>
