...
export default function ContentManagementEdit({openModal}) {
  ...
  const handleSubmit = (e) => {
    console.log("materialTitle: ", "a");
    e.preventDefault();
    if (materialTitle === "" || adminMessage === "" || exerciseLink === "") {
      openModal("Todos los campos son obligatorios");
    }
  }
      ...
      <div className="contentManagementEdit">
        ...
        <div className="items-form-material">
          <form onSubmit={handleSubmit}>
            ...
            <button className="option-guardar">
            ...
            <div className="items">
              <div className="group-items">
                ...
                <div  className="items-form">
                  ...
                  <textarea id="mensajeAdministrador"
                    value={adminMessage}
...
ContentManagementEdit.propTypes = {
  openModal: PropTypes.func.isRequired, // Define que openModal es una función requerida
};
