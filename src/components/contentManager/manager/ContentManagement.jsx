...
export default function ContentManagement() {
  ...
  useEffect(() => {
    const fetchLectures = async () => {
      ...
      const uids = result
        .filter(lecture => lecture.modifiedBy)
        .map(lecture => lecture.modifiedBy);

      if (uids.length > 0) {
        const { names } = await getUsernamesFromIds({ uids });
        result
          .filter(lecture => lecture.modifiedBy)
          .forEach((lecture, index) => (lecture.modifiedBy = names[index]));
      }
      ...
      <div className="contenido-material">
        <div className="group-contenido">
          ...
          {filteredLectures.length === 0 ? (
            <h3 style={{ textAlign: 'center' }}>No hay lecturas disponibles</h3>
          ) : (
              ...
              <div className="items" key={lecture.id}>
                ...
                <div className="btn-options">
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `/manager/content/${emotionalSkill}/${lecture.id}`,
                      )
                    }
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `/manager/content/${emotionalSkill}/${lecture.id}/edit`,
                      )
                    }
                  >
                    <svg
                    ...
                    >
                      <path
                        d="M3 21.5V17.25L16.2 4.075C16.4 3.89167 16.621 3.75 16.863 3.65C17.105 3.55 17.359 3.5 17.625 3.5C17.891 3.5 18.1493 3.55 18.4 3.65C18.6507 3.75 18.8673 3.9 19.05 4.1L20.425 5.5C20.625 5.68333 20.771 5.9 20.863 6.15C20.955 6.4 21.0007 6.65 21 6.9C21 7.16667 20.9543 7.421 20.863 7.663C20.7717 7.905 20.6257 8.12567 20.425 8.325L7.25 21.5H3ZM17.6 8.3L19 6.9L17.6 5.5L16.2 6.9L17.6 8.3Z"
                        fill="#F6F6F6"
                      />
                    </svg>
                    <span>Editar</span>
        ...
        <div className="ruta-aprendizaje">
          ...
          <div
            className={
              'tema' +
              (emotionalSkill === 'conciencia-emocional' ? ' selected' : '')
            }
            onClick={() => changeCategory('conciencia-emocional')}
          >
            <div className="tema-contenido">
              <h3>Conciencia emocional</h3>
              <p>Conoce y es consciente de las emociones propias y ajenas.</p>
            </div>
          ...
          <div
            className={
              'tema' +
              (emotionalSkill === 'regulacion-emocional' ? ' selected' : '')
            }
            onClick={() => changeCategory('regulacion-emocional')}
          >
            <div className="tema-contenido">
              <h3>Regulación emocional</h3>
              <p>Gestiona y ajusta tus emociones.</p>
            </div>
          ...
          <div
            className={
              'tema' +
              (emotionalSkill === 'autonomia-emocional' ? ' selected' : '')
            }
            onClick={() => changeCategory('autonomia-emocional')}
          >
            <div className="tema-contenido">
              <h3>Autonomía emocional</h3>
              <p>Autogestiona emociones y pensamientos.</p>
            </div>
          ...
          <div
            className={
              'tema' +
              (emotionalSkill === 'competencia-social' ? ' selected' : '')
            }
            onClick={() => changeCategory('competencia-social')}
          >
            <div className="tema-contenido">
              <h3>Competencia social</h3>
              <p>Establece y mantiene relaciones interpersonales.</p>
            </div>
          ...
          <div
            className={
              'tema' +
              (emotionalSkill === 'competencia-bienestar' ? ' selected' : '')
            }
            onClick={() => changeCategory('competencia-bienestar')}
          >
            <div className="tema-contenido">
              <h3>Competencia para la vida y el bienestar</h3>
              <p>Afronta retos de manera positiva y constructiva.</p>
            </div>
          ...
          <div className="agregar-contenido" style={{ marginTop: '0.5rem' }}>
            <button
              onClick={() =>
                navigate(`/manager/content/${emotionalSkill}/suggestion`)
              }
            >
              <svg
                width="20"
              ...
              >
                <path
                  d="M19 10.5C19 5.80729 15.1927 2 10.5 2C5.80729 2 2 5.80729 2 10.5C2 15.1927 5.80729 19 10.5 19C15.1927 19 19 15.1927 19 10.5Z"
                  stroke="#F2F2F2"
                  strokeMiterlimit="10"
                />
                <path
                  d="M10.5 6.9585V14.0418"
                  stroke="#F2F2F2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M14.0417 10.5H6.95834"
                  stroke="#F2F2F2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
